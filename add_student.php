...
<video src="5.mp4" autoplay loop muted>
    ...
    <label for="registrationNumber" style="color=green,strong">student name:</label>
...
<div class="img-container">
            ...
            <button type="submit" style="align-content:center;"name="submit" class="btn btn-primary btn-100">Add Student</button>
